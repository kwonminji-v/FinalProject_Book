...
import EditorComponent from "../component/EditorComponent";  // EditorComponent의 경로에 맞게 수정
                    ...
                    <div className="col-md-8">
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text"  dangerouslySetInnerHTML={{ __html: content }}>{/*{content.replace(/<[^>]+>/g, '')}*/}</p>
